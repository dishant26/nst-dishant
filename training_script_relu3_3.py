...
def train(training_config):
    ...
    for epoch in range(training_config['num_of_epochs']):
        for batch_id, (content_batch, _) in enumerate(train_loader):
            ...
            target_content_representation = content_batch_set_of_feature_maps.relu3_3
            current_content_representation = stylized_batch_set_of_feature_maps.relu3_3
...
if __name__ == "__main__":
    ...
    # training related
    parser.add_argument("--style_img_name", type=str, help="style image name that will be used for training", default='happy.jpeg')
